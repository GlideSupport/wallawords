<?php
/**
 * Block Name: Theme Spacer
 *
 * The template for displaying the custom gutenberg block named Theme Spacer.
 *
...
$ww_blk_spacer = ( isset( $block_fields['ww_blk_spacer'] ) && '' !== $block_fields['ww_blk_spacer'] ) ? $block_fields['ww_blk_spacer'] : null;
...
<div id="<?php echo esc_html( $amp_id ); ?>" class="<?php echo esc_html( $amp_align_class . ' ' . $amp_class_name . ' ' . $amp_name ); ?> block-<?php echo esc_html( $block_name ); ?>">
	...
	<div class="devcause-spacer <?php echo esc_html( $ww_blk_spacer ); ?>"></div>
