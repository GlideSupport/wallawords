    ...
    <div id="game-screen" class="wrapper" style="display: none;">
        <div class="game-container">
            ...
            <div id="final-score-screen" class="final-score-screen sentence-list-container final-result" style="display: none;">
                <div class="ranking-result-tab-content" style="display:none">
                    <ul></ul>
                </div>
...
<!-- Old Code -->
 <div class="score-header">
            <div id="final-move-count" class="rank_0">
                <div class="level-icon-result "><img src="https://playground1stg.wpengine.com/wp-content/themes/wallawords/assets/src/images/classic-level.png" width="16" alt="Level Icon"></div>
                0
            </div>
        ...
        <div>
            <div class="review-result-tab-content" style="display:none">
                    <ol></ol>
                </div>
        </div>
        <?php endif;?>
